...
For the navigation of multi-wheeled AGV-s it is important to take into account
the \emph{jerk}, or the rate of change of acceleration. A curve where the
acceleration changes continuously would be considered to have $G^3$ continuity.
\cite{kokot2021arxiv}
