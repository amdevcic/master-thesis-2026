...
We also describe NURBS as “non-uniform” because its basis functions do not need to be
...
are limited in their capabilities. Most commonly they are limited to a degree of
three or lower; for example, the SVG standard is limited to only quadratic and
cubic curves. \cite{w3c_svg2} In some fields such as graphic design this is not
considered a problem, as their simplicity, portability and computation speed are
more valuable than highly precise shapes. Other fields, such as engineering or
...
$1.0$, and all Bezier curves can be expressed as a B-spline with knot
multiplicity, it can be concluded that NURBS are a superset of both B-splines
and Bezier curves. By implementing NURBS it is possible to cover all use cases
